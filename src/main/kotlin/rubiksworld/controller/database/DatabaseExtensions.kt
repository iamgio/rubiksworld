...
val Database.discounts get() = this.sequenceOf(Discounts)
val Database.orders get() = this.sequenceOf(Orders)
val Database.orderPresences get() = this.sequenceOf(OrderPresences)
val Database.friendships get() = this.sequenceOf(Friendships)
val Database.solves get() = this.sequenceOf(Solves)